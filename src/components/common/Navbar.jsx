...
const serviceCategories = [
  { name:"Mobile App Development", icon:Smartphone, slug:"mobile", sub:["Mobile App Development","Android App Development","iOS App Development","React Native App Development","Flutter App Development","Wearable App Development","PWA Development","AR/VR App Development","Startup App Development","Mobile App Maintenance","Cross-Platform Development","Mobile App Consulting"] },
  { name:"Website Development", icon:Globe, slug:"website", sub:["Website Development","Next.js Development","ReactJS Development","Full Stack Development","Laravel Development","NodeJS Development","WordPress Development","Shopify Development","eCommerce Development","CMS Development","Web Designing & UI/UX","Web App Development","Magento Development","HTML5 & Frontend Dev"] },
  { name:"Software Development", icon:Code2, slug:"software", sub:["Custom Software Development","SaaS Platform Development","ERP Development","CRM Development","LMS Development","POS System Development","Desktop App Development","Enterprise Software","Software Modernization","API & Integration Dev","Software Maintenance","Software Consulting"] },
  { name:"Artificial Intelligence", icon:Brain, slug:"ai", sub:["AI Development","Generative AI Development","AI Agent Development","AI Chatbot Development","LLM Development & Fine-Tuning","Machine Learning Development","Computer Vision Development","NLP Development","Deep Learning Development","Speech Recognition","Predictive Analytics","MLOps & AI Infrastructure","IoT Development","AI Consulting Services"] },
  { name:"Blockchain Development", icon:Link2, slug:"blockchain", sub:["Blockchain Development","Smart Contract Development","NFT Marketplace Development","DeFi Protocol Development","Ethereum Development","Solana Development","Metaverse Development","Crypto Exchange Development","Crypto Payment Gateway","ICO & Token Launch","Web3 dApp Development","Smart Contract Auditing"] },
  { name:"Enterprise Solution", icon:Building2, slug:"enterprise", sub:["Microsoft Azure Consulting","AWS Development","Google Cloud Services","Salesforce Consulting","SAP Consulting","Microsoft Power BI","Databricks Consulting","ServiceNow Development","IT Staff Augmentation","IT Consulting","Salesforce Development","SEO Services","Digital Marketing","Unity Game Development"] },
  { name:"On-Demand Solutions", icon:Lightbulb, slug:"on-demand", sub:["On-Demand App Development","Food Delivery App","Taxi & Ride-Hailing App","Grocery Delivery App","Healthcare On-Demand","Home Services App","Beauty & Salon App","Courier & Delivery App","eLearning & Tutoring App","Pet Services App","eWallet App","Dating App","Video Streaming App","Laundry App"] },
];

const hireRoles = [
  {icon:"🧠",name:"Hire AI Developers",slug:"ai-developers"},
