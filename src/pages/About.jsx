...
const values = [
  { icon:"🎯", title:"Excellence", desc:"We set the bar high and consistently deliver solutions that exceed client expectations in quality, performance, and reliability." },
  { icon:"🤝", title:"Integrity", desc:"Honest and transparent in every interaction. We build trust through clear communication and doing what we say, every time." },
  { icon:"🌍", title:"Global Mindset", desc:"Diverse teams from around the world bring unique perspectives that drive creative problem-solving and inclusive digital solutions." },
  { icon:"⚡", title:"Innovation", desc:"Always exploring new technologies and approaches — from AI to blockchain — to build better, faster, and smarter products." },
  { icon:"🔒", title:"Security First", desc:"Every system we build prioritizes data protection, compliance, and enterprise-grade security from day one." },
  { icon:"🚀", title:"Speed & Agility", desc:"Agile by nature, we deliver working software quickly and iterate fast based on real feedback and changing requirements." },
];
