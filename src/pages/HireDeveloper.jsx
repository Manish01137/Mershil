...
export default function HireDeveloper() {
  ...
  const otherRoles = [
    ["dedicated-developers","👨‍💻","Hire Dedicated Developers"],
    ["react-developers","⚛️","Hire ReactJS Developers"],
    ["node-developers","🟢","Hire NodeJS Developers"],
    ["flutter-developers","🐦","Hire Flutter Developers"],
    ["mobile-app-developers","📱","Hire Mobile Developers"],
    ["android-developers","🤖","Hire Android Developers"],
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-start">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-blue-800/60 border border-blue-700/50 text-blue-200 text-sm font-medium px-4 py-2 rounded-full mb-6 backdrop-blur-sm">
                ✨ Top 3% Vetted — Available in 48 Hours
              </div>
            ...
            {d.subSkills.map((sk, i) => (
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-2xl flex-shrink-0 group-hover:bg-blue-100 transition">
                    {sk.icon}
                  </div>
      ...
      <section className="py-20 bg-blue-700 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-200 text-sm mt-6">
            ✔ 500+ Engineers &nbsp;✔ 48hr Onboarding &nbsp;✔ Zero Risk Trial &nbsp;✔ Flexible Contracts
          </p>
        </div>
      </section>
