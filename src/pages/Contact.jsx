...
export default function Contact() {
  ...
  const offices = [
    { flag:"🇺🇸", city:"Denver, Colorado", addr:"3033 East First Avenue, Suite 415, Denver, CO 80206" },
    { flag:"🇦🇺", city:"Sydney, Australia", addr:"Level 12, 123 Pitt Street, Sydney NSW 2000" },
    { flag:"🇬🇧", city:"London, UK", addr:"45 Old Street, Shoreditch, London EC1V 9HW" },
  ];
